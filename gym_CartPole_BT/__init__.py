...
register(
    ...
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"disturbances": "low", "measurement_noise": "low"},
)
register(
    id="CartPole-BT-dL-nH-v1",
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"disturbances": "low", "measurement_noise": "high"},
)
...
register(
    ...
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"output_matrix": _p2, "disturbances": "low", "measurement_noise": "low"},
)
register(
    id="CartPole-BT-p2-dL-nH-v1",
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"output_matrix": _p2, "disturbances": "low", "measurement_noise": "high"},
)
...
register(
    ...
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"goal_state": _x2_goal, "initial_state": _x2_initial, "disturbances": "low", "measurement_noise": "low"},
)
register(
    id="CartPole-BT-x2-dL-nH-v1",
    entry_point="gym_CartPole_BT.envs.cartpole_bt:CartPoleBTEnv",
    max_episode_steps=100,
    kwargs={"goal_state": _x2_goal, "initial_state": _x2_initial, "disturbances": "low", "measurement_noise": "high"},
)
